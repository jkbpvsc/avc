...
// export const RESPAWN_RATE_PERCENT = 0.5;
// let VAR1 = 0;
// export const comparisonSet = generateComparisonSet(POPULATION);
//
// let LINE_COLOR;
//
// let mic;
...
//     p.soundFormats('mp3');
//     track = p.loadSound('../assets/jonh/04 - Collider.mp3');
// }
//
// function setup () {
